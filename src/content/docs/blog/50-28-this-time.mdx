...
Because docs has to be written for everyone, we often can't know our readers' prior actions and experiences. But, with guided content, it's safe to assume they've followed any and all previous steps. In my books, that's fair game for an assumed frame of reference!

...
Maintaining commumunity-driven docs means identifying and channelling the desire to contribute. Community is the lifeblood of an open-source project. It's who we write the docs *for* and the reason we exist.

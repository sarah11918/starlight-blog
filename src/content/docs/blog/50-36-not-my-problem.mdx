...
date: 2024-07-29
pubDate: '2024-07-29'
excerpt: 'Tip 36 of "50 tips in 50 days before I turn 50!"'
...
One PR suggestion I often make is to **keep the focus on connecting to external services and possible interactions between projects, not (re)documenting how they work**. And *absolutely* avoid describing their UI at all costs! It is still possible to provide helpful guidance without providing too many details that are subject to change. Use language consistent with the other project's documentation so your readers can cross-check or search in their documentation when they need further instruction.

...
One PR suggestion I often make is to **keep the focus on the interactions with and connections to external services, not how they work**. And *absolutely* avoid describing their UI at all costs! It is still possible to provide helpful guidance without providing too many details that are subject to change. Use language consistent with the other project's documentation so your readers can cross-check or search in their documentation when they need further instruction.

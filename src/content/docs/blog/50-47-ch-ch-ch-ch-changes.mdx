...
One PR suggestion I often make is to **include actionable guidance guidance for the reader alongside a description of the change**. Your project *has* changes. Your reader needs to *make* changes! Connecting those dots in your change documentation can remove a lot of the pain, suffering, and stress of upgrading to a new version.

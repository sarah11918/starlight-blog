...
Experienced writers and editors can spot the wrong version of "it's/its", "there/their/they're", or "opt in/opt-in" a mile a way. These tiny mistakes are so common (we all make them!) and we are primed to see them when we're reviewing. Sometimes in our haste to correct them, we run the risk of missing the "better edit." 

...
Consider what your reader will see when skimming your inline styles, and what information you are *really* conveying to them. What will a reader take away if **"not"** is all they see? And, if my sentence depends on being read in *exactly* one way, then maybe I need to reconsider how clear it really is. 😅

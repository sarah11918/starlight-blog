...
hero:
  ...
  image:
    file:  ../../assets/heartjay.webp
    alt: A blue jay with a cheeky expression, head lowered and wings up forming a heart shape.
  actions:
...
Sarah photographs birds, watches baseball, sings in choirs, and contributes to open source projects!
...
Sarah Rainsberger has years of experience leading a large open source software documentation project with several maintainers and over 1000 community contributors. She brings a background in high school mathematics education, academic counseling, and curriculum development to her current technical writing and open source community building. In her spare time, she photographs birds. 
...
📺 [Making Meaningful Open-Source Contributions](https://www.youtube.com/watch?v=bzogTYPv65M) - Viteconf 2025
...
📺 [Happy Contributors, High Standards: Pick two! Balancing quality and community in open source documentation](https://www.youtube.com/watch?v=emgFALmCyrY&list=PLZAeFn6dfHpktOcWn5mQNOx5gYo6O7TR6&index=6) - Write the Docs Australia 2022
...
📺 Scrimba Town Hall: [Chat with Sarah Rainsberger: From Scrimba student to Astro core maintainer](https://www.youtube.com/watch?v=ea8kp0Z-gYk&list=PL8Qn4kutqAEuDiRlQ7TD2lthxTKtrbQTc&index=5)
...
I am a core maintainer for [Astro](https://astro.build), an open-source web framework. I also write and speak about managing and maintaining community-driven, open-source documentation.
...
I became a core maintainer with significant responsibilities in several aspects of maintaining this open source project, which in fact requires a LOT more than code to function! From 2022-2026, I led a team responsible for documentation, our public-facing websites, community, support, as well as some sustainability projects.
...
I am still a core maintainer at Astro, but am also involved with other open source projects such as [Astrolicious](https://astrolicious.dev/), [Expresssive Code](https://expressive-code.com/), and [npmx](https://npmx.dev/).

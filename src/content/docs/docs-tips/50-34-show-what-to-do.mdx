...
There's a good reason for that: how do you become a better writer? **Read quality writing** so you can internalize patterns to use in your own writing. What this means for docs is showing the "good" version and not the "bad" version so that you don't inadvertently introduce, or reinforce, unwanted patterns.

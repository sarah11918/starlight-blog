...
And, I hope if you do that, it feels a *little* weird to you, and it prompts you to try alternatives such as, "You must now create a new page..." Eventually, I hope it feels the most natural to just write "Create a new page..." and [give your reader a direct instruction](/docs-tips/50-41-if-you-please)!

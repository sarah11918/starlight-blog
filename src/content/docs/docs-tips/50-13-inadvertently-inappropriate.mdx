...
While ["like" often doesn't convey *enough* information](/docs-tips/50-09-dislike-like), some words convey too much: another meaning or nuance that you don't intend. And if you're super lucky, you might encounter a word that does both!
...
- 😐 "Any appropriate page file (`.astro`, `.md`, `.mdx`, `.js`/.`ts`, `.html`) located within `src/pages/` automatically creates its own page route on your website."
...
While I *do* often vary my language by using synonyms because presenting the same things said in different ways can be an [effective form of repetition as a pedagogical technique](/docs-tips/50-03-repetition-pedagogical-tool), I am also always on the lookout for any unintended messages.

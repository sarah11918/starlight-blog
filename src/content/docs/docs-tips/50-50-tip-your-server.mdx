...
We try to [avoid sticky note docs](/docs-tips/50-45-and-another-thing), where new pieces of information feel bolted on and fight for our readers' attention. Instead, we prefer to carefully weave new content into existing documentation whenever possible.
...
It is indented to be **helpful**. It is shared from the trenches of experience, a cave of wisdom, a place of love.

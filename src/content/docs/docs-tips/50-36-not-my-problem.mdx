...
When Astro's code changes, I know about it. I monitor the appropriate repositories. I am directly notified to review accompanying docs changes, and I am even brought in to assist [writing helpful CHANGELOG entries](/docs-tips/50-19-be-the-change). When a feature, process, setting, or website UI changes at Netlify... I wouldn't even know *until my docs are already wrong* and I am be at the mercy of a reader discoving and pointing it out.

"Docs are never done" and require continual (continuous? 😅) maintenance. Docs will occasionally be out of date. It may not always be my responsibility, but it's my problem! To help keep up, I don't take on any more responsibility than I need to.

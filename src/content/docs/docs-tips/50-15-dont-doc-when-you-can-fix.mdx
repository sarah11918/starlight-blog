...
And, I *still* want them to know "how Astro works" even if it's temporarily not working! Yes, following your docs might not work at this exact moment, but when the workaround is removed... how will they know they no longer need this hack? Not only have they used (and maybe internalized?) a non-standard pattern, now you've given them a maintenance burden that they didn't sign up for ... a maintenance burden that *you* have now signed up for, too, by the way.

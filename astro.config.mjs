		...
		starlight({
			...
			social: [
				{
					icon: "github",
					label: "GitHub",
					href: "https://github.com/sarah11918/starlight-blog",
				},
				{
					icon: "mastodon",
					label: "Mastodon",
					href: "https://mastodon.social/@sarah11918",
				},
				{
					icon: "blueSky",
					label: "Bluesky",
					href: "https://bsky.app/profile/sarah11918.rainsberger.ca",
				},
				...
				{ icon: "twitter", label: "Twitter", href: "https://x.com/sarah11918" },
				{
					icon: "youtube",
					label: "YouTube",
					href: "https://youtube.com/sarahrainsberger",
				},
				{
					icon: "rss",
					label: "RSS",
					href: "https://www.rainsberger.ca/blog/rss.xml",
				},
			...
			sidebar: [
				...
				},
				{
					...
					items: [
						{
							label: "50 docs tips in 50 days",
							link: "/blog/50-docs-tips-in-50-days",
						},
						{
							label: "Stop writing docs. Start helping!",
							link: "/blog/stop-writing-start-helping",
						},
						{
							label: "The value of non-code contributions to open source",
							link: "/blog/non-code-contributions",
						},
						{
							label: "Astro's Community-Driven Docs",
							link: "/blog/community-driven-astro-docs",
						},
					],
				},
				{
